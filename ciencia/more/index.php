<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('ciencia', 'mas-ciencia');
...
<div class="container mt-5 lineBottom">
    <h2 class="text-center"><i class="fas fa-atom"></i> Todo Ciencia</h2>
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('ciencia', 'mas-ciencia'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('ciencia', 'mas-ciencia', $iniciar, $articulos_por_pagina); 
