<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('entretenimiento', 'peliculas');
...
<div class="container mt-5 lineBottom">
    <h2 class="text-center"><i class="fas fa-film"></i> Películas</h2>
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('entretenimiento', 'peliculas'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('entretenimiento', 'peliculas', $iniciar, $articulos_por_pagina); 
