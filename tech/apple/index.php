...
<div class="container mt-5 lineBottom">
    ...
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('tech', 'apple'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('tech', 'apple', $iniciar, $articulos_por_pagina); 
