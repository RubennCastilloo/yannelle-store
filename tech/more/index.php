<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('tech', 'mas-tech');
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('tech', 'mas-tech', $iniciar, $articulos_por_pagina); 
