<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('tech', 'facebook');
...
<div class="container mt-5 lineBottom">
    <h2 class="text-center"><i class="fab fa-facebook-square"></i> Facebook</h2>
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('tech', 'facebook'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('tech', 'facebook', $iniciar, $articulos_por_pagina); 
