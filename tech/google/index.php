<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('tech', 'google');
...
<div class="container mt-5 lineBottom">
    <h2 class="text-center"><i class="fab fa-google"></i> Google</h2>
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('tech', 'google'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('tech', 'google', $iniciar, $articulos_por_pagina); 
