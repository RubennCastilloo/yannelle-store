<?php 
    ...
    $resultado = obtenerPublicacionesCategorias('tech', 'amazon');
...
<div class="container mt-5 lineBottom">
    <h2 class="text-center"><i class="fab fa-amazon"></i> Apple</h2>
    <p class="text-left mb-5">
        <?php 
        $descripciones = obtenerDescripcionCategoria('tech', 'amazon'); 
...
<div class="container-fluid notes mt-5 lineBottom">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
            <?php $publicaciones = obtenerPublicacionesSubcategoriaPaginadas('tech', 'amazon', $iniciar, $articulos_por_pagina); 
